...
Contents of this file
   ...
   7. My collider shape is not updating for the lights (IMPORTANT)
   8. The shadows coming from Boxes/Circles look weird (IMPORTANT)
   9. I want to use my own shader
   10. Should it be working while in Edit Mode?
   11. How can I hide the lights on the Scene view?
   12. There's something wrong / How can I contact you?
...
-------------
   ...
   7. My collider shape is not updating for the lights (IMPORTANT)
      ...
      of any collider and base every calculation around that. 
